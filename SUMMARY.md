 ...
 * [Интеграция с Active Directory/Samba DC](settings/users/active-directory/README.md)
    ...
    * [Аутентификация пользователей AD/Samba DC](settings/users/active-directory/ad-user-authorization.md)
       * [Настройка сервера Active Directory](settings/users/active-directory/ad-server-configuring.md)
       * [Настройка клиентских машин](settings/users/active-directory/ad-web-authentication.md)
