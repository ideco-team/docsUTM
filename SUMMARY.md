...
* [Профили безопасности](settings/security-profiles/README.md)
  * [Профили контроля приложений](settings/security-profiles/application-control/README.md)
    * [Особенности создания профилей](settings/security-profiles/application-control/profile-creation.md)
    * [Примеры создания профилей](settings/security-profiles/application-control/examples.md)
