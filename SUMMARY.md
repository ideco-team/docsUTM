...
* [Сервисы](settings/services/README.md)
  * [Сетевые интерфейсы](settings/services/connection-to-provider/README.md)
    * [Внешние и локальные](settings/services/connection-to-provider/all-ethernet.md)
    ...
    * [Агрегированные (LACP)](settings/services/connection-to-provider/lacp-connection.md)
    * [Туннельные (GRE)](settings/services/connection-to-provider/gre-connection.md)
