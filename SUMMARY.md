...
* [Пользователи](settings/users/README.md)
  ...
  * [Авторизация пользователей](settings/users/authorization/README.md)
    ...
    * [Фиксированные IP-адреса VPN](settings/users/authorization/fixed-ip-vpn.md)
...
* [Сервисы](settings/services/README.md)
  * [Сетевые интерфейсы](settings/connection-to-provider/README.md)
    * [Настройка Локального Ethernet](settings/connection-to-provider/local-ethernet.md)
    * [Настройка Внешнего Ethernet](settings/connection-to-provider/ethernet-connection.md)
  ...
  * [IPSec](settings/services/ipsec/README.md)
    ...
    * [Подключение офисов (site-to-site)](settings/services/ipsec/connect-offices/README.md)
      * [PPTP VPN](settings/services/ipsec/connect-offices/pptp-vpn.md)
      * [Входящее подключение Cisco IOS к Ideco UTM по IPSec](settings/services/ipsec/connect-offices/connect-cisco-to-utm-via-ipsec.md)
      * [Исходящее подключение Ideco UTM к Cisco IOS по IPSec](settings/services/ipsec/connect-offices/connect-utm-to-cisco-via-ipsec.md)
      * [Входящее подключение pfSense к Ideco UTM по IPsec](settings/services/ipsec/connect-offices/ipsec-connection-pfsense-to-utm.md)
      * [Исходящее подключение pfSense к Ideco UTM по IPsec](settings/services/ipsec/connect-offices/out-ipsec-connection-pfsense-to-utm.md)
      * [Подключение Keenetic по SSTP](settings/services/ipsec/connect-offices/sstp-connection-keenetic.md)
      * [Подключение Kerio Control к Ideco UTM по IPSec](settings/services/ipsec/connect-offices/ipsec-connection-kerio-control-to-utm.md)
      * [Подключение Keenetic по IPSec](settings/services/ipsec/connect-offices/keenetic-connection-via-ipsec.md)
...
* [Диагностика проблем](recipes/problem-diagnosis/README.md)
  ...
  * [Что делать если не работает Интернет](recipes/problem-diagnosis/internet-does-not-work.md)
