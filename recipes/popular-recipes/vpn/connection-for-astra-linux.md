...
1\. Откройте терминал сочетанием клавиш Ctrl+Alt+F1 или через путь **Пуск -> Системные -> Терминал Fly** и выполните команды:
...
5\. На вкладке **VPN** заполните следующие поля:
