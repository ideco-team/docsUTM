...
* **Пароль** - пароль пользователя. В правой части поля нужно выбрать вариант хранения для пароля от VPN-соединения;
...
8\. На вкладке **Identity (Идентификация)** заполните следующие поля:
...
* **Password** - пароль пользователя. В правой части поля нужно выбрать вариант хранения для пароля от VPN-соединения.
...
5\. На вкладке **Identity (Идентификация)** заполните следующие поля:
...
**Важно:** если в списке пакетов находится `go-l2tp`, его следует удалить командой:

```bash
sudo apt purge go-l2tp
```

5\. После окончания установки пакетов перейдите в **Настройки -> Сети** и в разделе **VPN** нажмите ![](/.gitbook/assets/icon-add.png):
...
7\. На вкладке **Идентификация** заполните следующие поля:
