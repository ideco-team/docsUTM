...
![](../../.gitbook/assets/p=1\_press.png)

3\. Нажмите комбинацию кнопок `Ctrl - X`. 4. После повторной загрузки системы появится окно создания аккаунта администратора. Задайте новый логин и пароль администратора.

![](../../.gitbook/assets/adm\_pass.png)
