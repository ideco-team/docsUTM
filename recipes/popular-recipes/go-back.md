...
При восстановлении на предыдущую версию данные перенесены не будут. Сохраните бэкап на внешнем носителе. Информация о работе с API бэкапа описана в статье [Бэкапы и возврат к предыдущей версии](/api/backup-api.md).
