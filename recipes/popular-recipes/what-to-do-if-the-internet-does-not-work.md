...
* Отключите модуль **Фаервол** в разделе веб-интерфейса **Правила трафика -&gt; Фаервол**. Если веб-интерфейс недоступен, то фаервол можно выключить с помощью локального меню.
* Если доступ к сети Интернет появился, найти правило запрещающее доступ к сети в фаервол, поочередно включая правила.
