...
2\. Загрузите созданную копию на ваш компьютер, нажав на кнопку ![](/.gitbook/assets/icon-backup1.png) в столбце **Управление**.
...
2\. Выберите сетевую карту, MAC-адрес которой вы ранее записали, и настройте интерфейс.
