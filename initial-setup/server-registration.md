---
description: >-
    В статье представлена информация о процессе привязки лицензии к серверу NGFW VPP.
---
...
1\. В веб-интерфейсе Ideco NGFW VPP перейдите в раздел **Управление сервером -> Лицензия** и выберите **Ручная загрузка** в качестве способа обновления и нажмите **Сохранить**.

2\. Скачайте файл со ссылками на регистрацию сервера и скачивание баз и лицензии, нажав на кнопку, или скопируйте ссылки из веб-интерфейса:
...
* Перейдите по ссылке для получения лицензии из пункта 2 и скачайте файлы, нажав на ссылки в открывшейся форме:
...
Чтобы обновить базы модулей безопасности в режиме офлайн, перейдите в веб-интерфейс Ideco NGFW VPP в раздел **Управление сервером -> Обновления -> Базы фильтрации** и загрузите скачанные в пункте 6 [Офлайн-регистрации](/initial-setup/server-registration.md#офлайн-регистрация) файлы, нажав на соответствующие кнопки:
