...
1\. Нажмите на иконку ![ok\_with\_icon.png](<../.gitbook/assets/ok\_with\_icon (3) (3) (3) (6) (6) (5) (1).png>) в правом верхнем углу и выберите пункт **Внешний Ethernet**.
...
При настройке локального интерфейса не указывайте шлюз, если имеется внешний настроенный интерфейс во избежание неполадок с маршрутизацией.

{% hint style="warning" %}
Указывайте шлюз на локальном интерфейсе только при отсутствии внешнего интерфейса.
{% endhint %}
