...
8\. Так же появится диалоговое окно, что подтверждающее запись на USB flash диск.

Далее, действуйте согласно инструкции мастера установки. Шаги по установке Ideco UTM VPP описаны в статье Рекомендации при первоначальной настройке.

## В среде Linux

Для создания загрузочного USB flash диска в Linux достаточно поблочно скопировать ISO-образ Ideco UTM VPP на устройство. Ниже описаны два способа:
