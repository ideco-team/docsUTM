...
1. [Создайте пользователя](../users/user-tree.md#kak-sozdat-uchetnuyu-zapis-polzovatelya) в Ideco UTM или [импортируйте](../users/user-tree.md#import-polzovatelei-iz-active-directory) его из Active Directory, который будет авторизован по IP.
