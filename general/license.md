...
<details>
<summary>Изменения лицензирования с режимом кластеризации, начиная с версии 18</summary>

Начиная с 18 версии, в системе лицензирования с режимом кластеризации произошли изменения:
...
Техническая поддержка не предоставляется. Недоступно: **Кластеризация**, **Расширенная база правил** (от Лаборатории Касперского) для модуля **Предотвращение вторжений**, **Антивирус Касперского** и **Kaspersky Anti-Spam**.
