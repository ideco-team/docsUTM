...
> Начиная с версии UTM 7.0.0, подключиться из сети Интернет программой Outlook \(любой версии\) по протоколу POP3 нельзя. Outlook не поддерживает тип шифрования STARTTLS для POP3, а поддерживает только устаревшие и небезопасные SSL/TLS, которые в нашем почтовом сервере более не используются. Подключение без шифрования извне также запрещено на нашем почтовом сервере. Тем не менее остается возможность подключаться по протоколу IMAP с использованием STARTTLS. Для этого выберите тип шифрования **Авто** в Outlook. {.is-warning}
...
Пример настроек клиента Microsoft Outlook 2013 по протоколу IMAP: ![outlook2013.jpg](../../.gitbook/assets/outlook2013.jpg) Пример настроек клиента Microsoft Outlook 2016 по протоколу IMAP: ![outlook2016.jpg](../../.gitbook/assets/outlook2016.jpg) Для отображения IMAP-папок снимите галочку **При просмотре дерева в Outlook показывать только подписанные папки** в свойствах IMAP-папок: ![imap\_outlook.png](../../.gitbook/assets/imap_outlook.png) ![imap\_outlook2.png](../../.gitbook/assets/imap_outlook2.png)
...
![iphonecert004.png](../../.gitbook/assets/iphonecert004.png)

![iphonecert005.png](../../.gitbook/assets/iphonecert005.png)

![iphonecert006.png](../../.gitbook/assets/iphonecert006.png)

После установки сертификата настройте доступ в почтовый ящик как показано на следующих скриншотах:

![iphone003.jpg](../../.gitbook/assets/iphone003.jpg)

![iphone002.jpg](../../.gitbook/assets/iphone002.jpg)

![iphone001.jpg](../../.gitbook/assets/iphone001.jpg)

### Настройка почтового клиента Thunderbird

![thunder001.png](../../.gitbook/assets/thunder001.png) ![thunder002.png](../../.gitbook/assets/thunder002.png) ![thunder003.png](../../.gitbook/assets/thunder003.png)
