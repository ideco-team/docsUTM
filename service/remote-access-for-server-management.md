...
Прямой доступ к веб-интерфейсу Ideco UTM из сети Интернет запрещен по умолчанию. ВИспользуйте один из способов, указанных ниже:
...
3.  Создать правило в обратном прокси для публикации веб-интерфейса:
    ...
    3.4. Зайдите по одному из адресов, которые указали в **запрашиваемых адресах**
