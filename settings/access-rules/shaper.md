...
Также сохраненные, но не примененные правила потеряются в слудующий случаях:
* При перезагрузке сервера.
* В случае переключения на другую ноду.
* При перезагрузке или остановке службы ограничения скорости (в случаях, когда произошёл сбой службы или при работе сотрудника технической поддержки со службой).
{% endhint %}
