---
description: >-
  Средство управления трафиком на сервере (межсетевой экран). Помогает ограничивать пользовательский трафик, проходящий из локальных сетей во внешние через сервер; между разными локальными сетями сервера; на сам сервер Ideco UTM.
---
