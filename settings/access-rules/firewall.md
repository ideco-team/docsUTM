...
Принцип работы **Файрвола** - анализ заголовков пакетов, проходящих через интерфейсы сервера. Полный анализ трафика уровня L3 осуществляется, когда Ideco NGFW является единственным шлюзом в сети. С помощью **Файрвола** определяются глобальные правила управления трафиком по сетевым протоколам, портам и другим значениям в заголовках сетевых пакетов.
