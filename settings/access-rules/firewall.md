...
* В одной строке следует указывать только один IP-адрес или одну сеть. Наличие пробелов или иных символов после адреса не допускается.
...
{% hint style="info" %} 
После перезагрузки Ideco UTM IP-адреса из файла будут автоматически блокироваться. При обновлении Ideco UTM, список блокировок сохранится.

Если требуется добавление адресов в список заблокированных, следует добаить адреса в файл /var/opt/ideco/firewall-backend/manual_blocklist.txt и повторно выполнить команду ideco-apply-manual-blocklist.
