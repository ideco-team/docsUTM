...
**Файрвол** - средство управления трафиком на сервере (межсетевой экран). Поддерживает фильтрацию пакетов с контролем состояния соединений (Stateful Inspection), то есть анализирует заголовки IP-пакетов и TCP-сегментов, проходящих через интерфейсы сервера, и фильтрует трафик на основании параметров заголовков (IP-адреса, TCP/UDP-порты и флаги).
...
Для работы DPI/IPS в правилах **Файрвола** можно подключить **Профили фильтрации трафика**, создав разрешающее правило с включенной проверкой через **Контроль приложений** и/или систему **Предотвращения вторжений**. Профили настраиваются в разделе [**Профили безопасности**](/settings/security-profiles/README.md).
...
{% content-ref url="firewall-tables.md" %}
{% endcontent-ref %}

{% content-ref url="firewall-examples.md" %}
{% endcontent-ref %}

{% content-ref url="logging.md" %}
{% endcontent-ref %}

{% content-ref url="rule-check.md" %}
{% endcontent-ref %}

{% content-ref url="pre-filtration.md" %}
{% endcontent-ref %}

{% content-ref url="hardware-filtering.md" %}
{% endcontent-ref %}

{% content-ref url="/settings/security-profiles/application-control/README.md" %}
{% endcontent-ref %}

{% content-ref url="/settings/security-profiles/ips-profiles/README.md" %}
{% endcontent-ref %}