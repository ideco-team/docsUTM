...
<img src="../../.gitbook/assets/firewall5.png" alt="" data-size="original">
...
* **Расшифровка трафика** - выберите профиль [TLS/SSL-инспекции](../security-profiles/tls-inspection-security-profiles.md) для расшифровки трафика и его передачи на проверку модулям **Контент-фильтра**, **Контроля приложений**, **Предотвращения вторжений**;
* **Контроль приложений** - выберите профиль [Контроля приложений](../security-profiles/application-control/), которым требуется фильтровать трафик;
* **Контент-фильтр** - выберите профиль [Контент-фильтра](../security-profiles/content-filter-profiles.md), которым требуется фильтровать трафик;
* **Предотвращение вторжений** - выберите профиль системы [Предотвращения вторжений](../security-profiles/ips-profiles.md), которым требуется фильтровать трафик.
...
<img src="../../.gitbook/assets/firewall2.png" alt="" data-size="original">
...
<img src="../../.gitbook/assets/firewall3.png" alt="" data-size="original">
...
<img src="../../.gitbook/assets/firewall4.png" alt="" data-size="original">
