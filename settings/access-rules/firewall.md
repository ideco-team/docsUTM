...
{% hint style="info" %} 
После перезагрузки Ideco UTM IP-адреса и сети из файла будут автоматически блокироваться. При обновлении Ideco UTM, список блокировок сохранится, дополнительно выполнять утилиту  ideco-apply-manual-blocklist не нужно.
{% endhint %}
