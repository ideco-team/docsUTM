...
Логи записываются в системный журнал. Для просмотра логов перейдите в раздел **Отчеты и журналы -> Системный журнал**. Подробнее в статье [Системный журнал](/settings/reports/logs.md). Логи могут отправляться через [syslog](/settings/reports/syslog.md).
