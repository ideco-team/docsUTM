...
Ideco UTM анализирует трафик, ищет правило, которое подходит к этому трафику из списка, и применяет его. Если в списке есть несколько правил с одними и теми же условиями (колонки "Применяются для" и "Протоколы"), но разными действиями (колонка "Действие"), то будет применено то, у которого более высокий приоритет.
