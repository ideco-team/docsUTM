...
| :------------: | --------------- | ----------------- |
|![](../../.gitbook/assets/ok-with-icon.png)| Добавить           | Добавление правил             |
|![](../../.gitbook/assets/icon-enable.png) | Включить/Выключить | Если правило выключено, то действовать оно не будет |
|![](../../.gitbook/assets/icon-up.png)     | Повысить приоритет | Повышает приоритет. Правило выполняется вперед правил с более низким приоритетом |
|![](../../.gitbook/assets/icon-down.png)   | Понизить приоритет | Понижает приоритет. Правило выполняется после правил с более высоким приоритетом  |
|![](../../.gitbook/assets/icon-edit.png)   | Редактировать      | Откроется окно изменения ранее созданного правила |
|![](../../.gitbook/assets/delete_icon.png) | Удалить            | Удаление созданного правила   |

Принцип действия набора правил:

Ideco UTM анализирует трафик и ищет правило, которое подходит к этому трафику из списка и применяет его. Если в списке есть несколько правил с одними и теми же условиями (колонки "Применяются для" и "Протоколы"), но разными действиями (колонка "Действие"), то будет применено то, у которого более высокий приоритет.
