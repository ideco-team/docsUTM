...
Перейдите в раздел **Правила трафика -&gt; Контент-фильтр -&gt; Настройки** и активируйте базу расширенного контент-фильтра, переключив ползунок в положение **Включено** у пункта **Использовать расширенную базу категорий**.
