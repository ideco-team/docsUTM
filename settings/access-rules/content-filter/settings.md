...
Активация опции **Расширенная база категорий** включает более 140 автоматически обновляемых категорий, доступных только при активной подписке в коммерческих редакциях продукта:
...
**Безопасный поиск** - принудительно включает безопасный поиск в поисковых системах (Google, Yandex, YouTube, Yahoo, Bing, Rambler). **Для корректной работы необходимо включить HTTPS-фильтрацию с подменой сертификата для этих сервисов**.
