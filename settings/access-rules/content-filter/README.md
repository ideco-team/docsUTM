...
Механизм контентной фильтрации работает по принципу проверки принадлежности адреса сайта на наличие в списках запрещенных ресурсов. Списки поделены на категории для удобства администрирования.
