 ...
 **Категория** | **Описание** 
---|---
 Сети заражённых устройств и управляющие серверы | Интернет-серверы, использующиеся для управления ботнетами 
...
В версии 20 Ideco NGFW состав категорий контент-фильтра претерпел изменения. Часть категорий удалены, часть объединены в общие категории.
...
Категории без изменений выделены *курсивом*.

| Расширенная категория в v19 | Соответствующая категория в v20 |
|---|---|
| Web-почта | Веб-почта |
...
| Ботнеты | Сети заражённых устройств и управляющие серверы |
...
| *Войска и вооружения* | *Войска и вооружения* |
...
| *Искусство* | *Искусство* |
| *Казино, лотереи, тотализаторы* | *Казино, лотереи, тотализаторы* |
| Каталоги | Порталы |
...
| *Неизвестные сайты* | *Неизвестные сайты* |
...
| *Образование и учебные учреждения* | *Образование и учебные учреждения* |
| Онлайн-офисы | Порталы |
| *Онлайн-реклама и баннеры* | *Онлайн-реклама и баннеры* |
...
| *Платные сайты мобильных операторов* | *Платные сайты сотовых операторов* |
...
| *Сайты для детей* | *Сайты для детей* |
...
| Центры управления и контроля | Сети заражённых устройств и управляющие серверы |
| Частные IP-адреса | Категория удалена |
...
{% hint style="warning" %}
При переходе Ideco NGFW с версии 19 на 20 произведется подстановка категорий в правила, в соответствии с таблицей выше. Если в версии 20 нужная категория отсутствует, то поле **Категории сайтов** останется пустым, а правило перестанет работать.
{% endhint %}