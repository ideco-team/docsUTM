...
* Морфологический анализ проводится только с использованием **включенных словарей**. Если ни один словарь не включен, морфологический анализ не проводится.
* Морфологический анализ работает только с расшифрованным трафиком - создайте правило расшифровки трафика в **Контент-фильтре**.
...
Результат морфологического анализа представлен в разделе **Отчеты и журналы -> [Журнал веб-трафика](/settings/reports/web-traffic-log.md)**. В журнале также отображаются дата и время, причина запрета, название правила, название морфологического словаря, IP источника и имя пользователя:
