...
Задача: Запретить пользователям вводить данные на запрещенных сайтах. 
...
* **Категории сайтов** - укажите категорию **Запрещенные сайты**. 
* **HTTP-методы** - выбеите метод `POST`, чтобы запретить отправку данных на определенный ресурс.
* **Запретить** - выберите опцию, чтобы правило работало как запрещающее.
