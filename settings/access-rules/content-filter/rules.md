...
В столбце **Управление** можно включать или отключать правило, менять приоритет, редактировать и удалять. Правила контентной фильтрации применяются сразу после их создания или включения:
