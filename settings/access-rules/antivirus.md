...
Антивирус в продукте создан на базе Kaspersky Anti-Virus Software Development Kit. Для включения модуля перейдите в раздел **Правила трафика -> Антивирусы веб-трафика**:
...
Модуль **Антивирусы веб-трафика** связан с прокси-сервером и **Контент-фильтром**, поэтому фильтрует веб-трафик при выполнении следующих условий:
...
Результат проверки трафика антивирусом представлен в [Журнале антивируса](/settings/reports/antivirus-logs.md).
