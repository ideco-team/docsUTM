...
В настройках можно выбрать, какой антивирусный модуль использовать: антивирус от Лаборатории Касперского. Антивирус лицензируется отдельно, его использование может быть ограничено условиями лицензии:
