...
Чтобы активировать автоматический SNAT для локальных сетей, переведите соответствующую опцию в положение **Включен**. Пользовательские правила SNAT имеют приоритет над автоматическим SNAT для локальных сетей.

Автоматический SNAT подменяет адреса источников только для следующих диапазонов: `192.168.0.0/16`, `172.16.0.0/12` и `10.0.0.0/8`.
...
1\. На вкладке **FOFWARD** нажмите **Добавить**;
