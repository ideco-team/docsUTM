...
При создании правил для фильтрации веб-трафика из локальных сетей (80, 443 TCP порты), для полноценной работы правила, в поле **Входящая зона** должен указываться объект **Любой**. Если будет указан иной объект в поле **Входящая зона**, то правило не будет обрабатывать веб-трафик.
