...
* В предыдущих версиях профили безопасности настраивались в отдельных разделах. В версии 18 [**Контроль приложений**](/settings/security-profiles/application-control.md) и система [**Предотвращения вторжений**](/settings/security-profiles/ips-profiles.md) настраиваются в правилах **Файрвола**;
