...
* В предыдущих версиях профили безопасности настраивались в отдельных разделах. В версии 18 [**Контроль приложений**](/settings/security-profiles/application-control/README.md) и система [**Предотвращения вторжений**](/settings/security-profiles/ips-profiles.md) настраиваются в правилах **Файрвола**;
...
* В случае проблем с доступом до публикуемой службы проверьте **Отчеты и журналы -> События безопасности -> Журнал IPS** и при необходимости отредактируйте правила нужного профиля [**Предотвращения вторжений**](/settings/security-profiles/ips-profiles.md).
