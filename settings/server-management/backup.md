...
**Бекапы включают в себя следующие настройки, созданные администратором:**

* Пользователи, профили и правила фаервола;
* Настройки всех остальных модулей (сетевые интерфейсы, ограничение скорости и т. д.);
* Сертификаты, сгенерированные автоматически и/или добавленные администратором;
* Пароли (в виде хеша) суперпользователя и удаленного помощника;
* Временную зону;
* Данные текущей лицензии.

**Бекапы не включают в себя:**

* Логи;
* Почту;
* Статистику web-трафика;
