...
{% hint style="warning" %}
После активации лицензия привязывается к оборудованию, на котором установлено программное обеспечение Ideco NGFW. При замене оборудования или его частей она отвязывается и требует повторной привязки. Демо-лицензия при этом теряется.
{% endhint %}
...
* В [MY.IDECO](https://my.ideco.ru/) на вкладке **Лицензирование** нажмите **Привязать лицензию**. Далее в открывшемся окне выберите нужную лицензию и сохраните изменения;
...
**Видеоинструкция по офлайн-привязки лицензии**:

{% embed url="https://rutube.ru/video/6f2432c7b6e98d41237954c35cf1cc7a/" %}
<!-- [Ссылка на видеоинструкция по офлайн-привязки лицензии](https://rutube.ru/video/6f2432c7b6e98d41237954c35cf1cc7a/) -->
