...
## Восстановление кластера на предыдущую версию

Перед восстановлением кластера убедитесь, что на жестком диске обеих нод сохранена версия UTM, на которую требуется восстановиться, и выполните действия: 

1\. Перейдите в локальное меню активной ноды;

2\. Выберите пункт **14 Восстановиться на предыдущую версию**:

![](../../.gitbook/assets/cluster13.png)

3\. Выберите версию для переключения и дождитесь перезагрузки ноды;

4\. После восстановления ноды на предыдущую версию, отключите ее выбрав пункт **16 Отключить сервер**:

![](../../.gitbook/assets/cluster14.png)

5\. Перейдите в локальное меню пассивной ноды и повторите действия 2 и 3;

6\. Включите ноду, отключенную в пункте 4.
