...
* Если сервер Ideco Center находится за NAT, укажите IP-адрес NAT-устройства или доменное имя, перейдя в Ideco Center в раздел **Управление сервером -> Дополнительно -> Адрес Ideco Center**.
