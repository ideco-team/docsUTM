...
* **Роль** - выберите роль:
  ...
  * **Просмотр отчетов** - администратору будет доступна часть раздела [Отчеты](../reports/), а именно Трафик, События безопасности и Журнал авторизации;
  * **Создание отчетов** - администратору будет доступен весь раздел [Отчеты](../reports/).
