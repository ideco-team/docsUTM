...
**Роль** - выберите роль:</summary>
  ...
  * **Просмотр отчетов** - администратору будет доступна часть раздела [Отчеты и журналы](/settings/reports/README.md), а именно Трафик, Системный журнал, Журнал веб-доступа, Журнал антивируса, События безопасности и Журнал авторизации;
  * **Создание отчетов** - администратору будет доступна часть раздела [Отчеты и журналы](/settings/reports/README.md), а именно Трафик, Системный журнал, Журнал веб-доступа, Журнал антивируса, События безопасности, Журнал авторизации и Конструктор отчетов.
