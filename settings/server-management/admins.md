...
* **Роль** - выберите роль:
  ...
  * **Просмотр отчетов** - администратору будет доступна часть раздела [Отчеты](/settings/reports/README.md), а именно Трафик, Журнал событий, Журнал веб-доступа, События безопасности и Журнал авторизации;
  * **Создание отчетов** - администратору будет доступна часть раздела [Отчеты](/settings/reports/README.md), а именно Трафик, Журнал событий, Журнал веб-доступа, События безопасности, Журнал авторизации и Конструктор отчетов.
