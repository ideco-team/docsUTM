...
* **Роль** - выберите роль:
  ...
  * **Просмотр отчетов** - администратору будет доступна часть раздела [Отчеты и журналы](/reports/README.md), а именно Трафик, Журнал событий, События безопасности, Действия администраторов и Журнал авторизации;
  * **Создание отчетов** - администратору будет доступна часть раздела [Отчеты и журналы](/reports/README.md), а именно Трафик, Журнал событий, События безопасности, Действия администраторов, Журнал авторизации и Конструктор отчетов.
