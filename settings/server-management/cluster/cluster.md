...
{% hint style="info" %}
Для настройки требуется активная лицензия с модулем **Кластеризация**. Подробную информацию о лицензировании кластера можно найти в [статье](/general/license.md).
{% endhint %}
