...
* При [Single Sign-On](/settings/users/active-directory/active-directory-user-authorization.md#nastroika-ideco-utm) авторизации через Active Directory IP-адрес Ideco NGFW указан в качестве шлюза в настройках сетевого интерфейса клиентских машин.
