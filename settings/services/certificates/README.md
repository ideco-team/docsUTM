...
Раздел позволяет загружать свои сертификаты в хранилище доверенных сертификатов OC Fedora на NGFW. Подробнее о системных сертификатах - по [ссылке](https://docs.fedoraproject.org/en-US/quick-docs/using-shared-system-certificates/). После добавления сертификата в таблицу **Системные сертификаты** NGFW будет доверять загруженному сертификату и всем сертификатам, подписанным загруженным сертификатом:
