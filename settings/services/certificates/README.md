...
Отображаются все загруженные цепочки сертификатов, а также корневой сертификат Ideco UTM. Подробнее в [Загрузка своего SSL-сертификата на сервер](../../services/certificates/upload-ssl-certificate-to-server.md)
...
При замене/перевыпуске корневого сертификата, [IPsec-соединения](../vpn-tunnel-protocols/site-to-site/ipsec/branch-office-and-main-office.md) **Главный офис <–> Филиал** перестанут работать и их необходимо будет пересоздать.
