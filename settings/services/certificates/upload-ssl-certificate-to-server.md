...
5. Сохраните файл с расширением **.pem** и воспользуйтесь [инструкцией по загрузке сертификата на NGFW](#zagruzka-ssl-sertifikata-na-utm).
...
Для загрузки подготовленного сертификата на Ideco NGFW выполните действия:
...
14\.  Получившийся файл загрузите в NGFW. Для этого перейдите в раздел **Сервисы -> Сертификаты**.
