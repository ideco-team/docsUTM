...
Для поиска некорректно заданной опции перейдите в раздел **Управление сервером -> Терминал** и откройте конфиг `/run/ideco-dhcp-server-backend/dnsmasq.conf`.
{% endhint %}
...
3\. Нажмите **Добавить опцию** и заполните 176 опцию. Она используется для указания/задания голосового сервера:
