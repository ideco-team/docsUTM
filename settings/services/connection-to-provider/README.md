...
* **Комментарий** - поле может быть пустым;
* **Интерфейсы источников** - выберите интерфейсы, трафик которых хотите дублировать. Доступные варианты: Ethernet-интерфейсы, VLAN, туннельные интерфейсы (GRE), IPsec- и GRE-over-IPsec-интерфейсы, а также Клиентский VPN-трафик;
...
{% hint style="info" %}
У пакетов, перенаправленных на SPAN-интерфейс с туннельных (GRE), IPsec- и GRE-over-IPsec-интерфейсов, будет отсутствовать Ethernet-заголовок.
{% endhint %}
