...
Ideco NGFW VPP заполнит поле **Router ID** автоматически. В VPP Router ID формируется при создании и изменении VPP-интерфейсов, поэтому если в VPP только один [Control Plane интерфейc](/initial-setup/setup.md), то значение Router ID будет **отсутствует**:
