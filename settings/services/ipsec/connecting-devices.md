...
1\. В Ideco UTM откройте вкладку **Сервисы -> IPSec -> Устройства**, нажмите на значок ![ok\_with\_icon.png](<../../../.gitbook/assets/ok-with-icon (23).png>) и заполните следующие поля:
