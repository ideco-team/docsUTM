...
1\. В Ideco UTM откройте вкладку **Сервисы -> IPSec -> Устройства**, нажмите на значок ![ok\_with\_icon.png](../../../.gitbook/assets/ok\_with\_icon%20\(3\)%20\(3\)%20\(3\)%20\(6\)%20\(6\)%20\(5\)%20\(10\).png) и заполните следующие поля:
