...
2\. Для клиентов, которым нужно предоставить доступ к этой сети по L2TP/IPSec, поставьте галочку **Использовать основной шлюз в удаленной сети** в свойствах VPN-подключения (**Сеть -> Протокол интернета TCP/IP версии 4 -> Дополнительно**).

3\. Для клиентов, подключенных к Ideco UTM по IKEv2/IPsec, маршруты локальных сетей UTM, маршрутизируемых и удаленных сетей передаются автоматически. 
