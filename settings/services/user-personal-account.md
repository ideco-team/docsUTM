...
Публикуемый внутренний ресурс должен быть готов к публикации через обратный прокси-сервер, а также соответствовать требованиям:

* Не обращаться к сторонним ресурсам;
* Работать с domain публикации.

В случае несоответствия перечисленным требованиям публикуемый ресурс будет отображаться некорректно, т.к. некоторые файлы (CSS и JS) могут быть недоступны с внешних ресурсов.
