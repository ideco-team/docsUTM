...
{% hint style="info" %}
Включение опции **Тест скорости** на вкладке **Правила доступа** предоставляет пользователям возможность проверить скорость интернета в личном кабинете, нажав на соответствующую кнопку.
{% endhint %}

{% hint style="warning" %}
В случае использования пользователями приватных (серых) IP-адресов, не указывайте в качестве источника страну, поскольку такие адреса не относятся к диапазонам IP-адресов ни одной из стран, и доступ к ним не будет разрешен. Рекомендуется использовать диапазон IP-адресов.
{% endhint %}
