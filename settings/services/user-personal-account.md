...
<summary>Требования к внутренним ресурсам для публикации</summary>

Публикуемый внутренний ресурс должен быть готов к публикации через **[Обратный прокси](/settings/services/reverse-proxy.md)**, а также соответствовать требованиям:

* Не обращаться к внешним ресурсам;
* Работать с domain публикации.

В случае несоответствия перечисленным требованиям публикуемый ресурс будет отображаться некорректно, т.к. некоторые файлы (например, CSS и JS) могут быть недоступны с внешних ресурсов.
