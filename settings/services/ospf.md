...
<!-- Чтобы получить настройки NGFW (в том числе конфигурацию OSPF) в представлении, аналогичном консоли Cisco, перейдите в терминал и введите:
...
1\. Авторизйтесь на MikroTik и выполните команду:
...
* **Redistribute connected** - будут анонсироваться маршруты напрямую подключенных подсетей, в том числе и [Loopback-интерфейсов](/settings/services/connection-to-provider/loopback.md). При отключении настройки сети Loopback-интерфейсов будут анонсироваться, если при добавлении в конфигурацию OSPF Loopback-интерфейса.
...
* Трафик будет автоматически баланироваться между **Провайдером-1** и **Провайдером-2**;
