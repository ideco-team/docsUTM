...
7. Если интернет-провайдер или вышестоящее устройство перехватывает DNS запросы, то использование стандартной конфигурации с корневыми серверами невозможно, и вам необходимо либо задать сервера вручную, либо использовать DNS сервера выданные подключению.
