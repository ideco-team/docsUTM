...
* **Указать DNS-серверы самостоятельно** - укажите DNS-серверы. Если DNS-серверы были приобретены на хостинге RU-CENTER, поля заполнятся автоматически;
...
9\. Сохраните настройки в Ideco UTM нажав **Сохранить**.