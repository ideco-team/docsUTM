...
2\. Установите флаг **Подключение по IKEv2/IPSec** и заполните поля **Домен** и **Маршруты**:
...
При необходимости заполните раздел  **Advanced**.
...
10\. Поставите переключатель созданного VPN-подключения в положение включен:
