...
1. В Ideco UTM откройте вкладку **Сервисы -> IPSec -> Устройства**, нажмите на значок ![ok\_with\_icon.png](<../../../../../.gitbook/assets/ok\_with\_icon (3) (3) (3) (6) (6) (5) (10).png>) и заполните следующие поля:
