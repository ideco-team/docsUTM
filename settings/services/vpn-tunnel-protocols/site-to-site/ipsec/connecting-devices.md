...
* **Phase 2 (ESP):**
  ...
  * DH (Группа Diffie-Hellman, PFS).\
    **ВНИМАНИЕ! если не указать, подключаться будет, но не сработает rekey через некоторое время**:&#x20;
    * **Curve25519 (group 31)**;
    * **ECP256 (group 19)**;
    * **modp4096 (group 16)**;
    * **modp2048 (group 14)**;
...
1\. В Ideco UTM откройте вкладку **Сервисы -> IPSec -> Устройства**, нажмите на значок ![ok\_with\_icon.png](<../../../../../.gitbook/assets/ok\_with\_icon (3) (3) (3) (6) (6) (5) (1).png>) и заполните следующие поля:
