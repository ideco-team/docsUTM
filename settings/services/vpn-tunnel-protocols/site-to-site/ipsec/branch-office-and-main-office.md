...
1\. Откройте раздел **Сервисы -> IPsec -> Филиал** нажмите кнопку ![](<../../../../../.gitbook/assets/ok-with-icon (3).png>) в верхнем правом углу экрана.
...
1\. Откройте раздел **Сервисы -> IPsec -> Главный офис** и нажмите кнопку ![](<../../../../../.gitbook/assets/ok-with-icon (3).png>) в верхнем правом углу экрана.
