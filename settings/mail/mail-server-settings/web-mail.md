...
После создания правила из локальной сети наберите в браузере: **`https://х.х.х.х/webmail/`**, где `х.х.х.х` - адрес локального интерфейса.
...
* В качестве пароля всегда прописывается пароль от учётной записи пользователя. **Установить отдельный пароль на почту нельзя.**
