...
Так же создайте TXT запись для вашего домена у держателя зоны с именем из строки _Имя записи_ и с содержимым, которое было сформировано Ideco UTM в **Значение записи**:
