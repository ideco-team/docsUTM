...
6\. Создайте TXT запись для вашего домена у держателя зоны с содержимым, которое было сформировано Ideco UTM в **Значение записи**, добавив в начало записи `v=DKIM1; k=rsa; p=`. Пример ниже на скриншоте:
