...
Когда все настройки произведены, из локальной сети в браузере наберите `https://х.х.х.х:8443/webmail`, где `х.х.х.х` - адрес локального интерфейса. \
Из сети Интернет наберите в браузере `https://test.co/mail`, где 66.77.88.99 - адрес внешнего интерфейса. **Для подключения обязательно использовать HTTPS.**
