...
3\. Ideco Client **не поддерживает** туннелирование по протоколу WireGuard. Возможна авторизация клиентов только в локальной сети;

4\.**Недоступна** авторизация пользователей через их SSO-профиль в "тихом" режиме автоподключения;
{% endhint %}
