...
* **Доменный суффикс** - при необходимости укажите [доменный суффикс](/settings/users/authentication/README.md#domennyi-suffiks) для аутентификации пользователей RADIUS-сервера. Например, при суффиксе `radius` локальные пользователи должны будут вводить логины в формате `username@radius`.
