...
* Для разных пользователей созданы правила **Авторизации по подсетям** с пересекающимися подсетями;
* На вкладке **Авторизация по подсетям** созданы правила авторизации пользователей по IP-адресам (например, 192.168.12.34/32);
