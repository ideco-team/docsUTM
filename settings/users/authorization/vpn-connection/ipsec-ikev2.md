...
Если если не был получен корневой сертификат на UTM через Let\`s Encrypt, то скачайте и установите корневой сертификат UTM на компьютер пользователя одним из способов:
