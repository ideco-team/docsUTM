...
При нескольких вариантах подключений по VPN выбирайте протоколы по критериям:
...
4\. После выполнения действий следуйте инструкции\
[Как запустить PowerShell-скрипт](running-powershell-scripts.md#kak-zapustit-powershell-skript) с 4 пункта.

</details>

<details>
<summary>Решение проблем запуска PowerShell-cкрипта</summary>
