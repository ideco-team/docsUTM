...
На вкладке настраиваются протоколы и адресация VPN-подключений. Для настройки:
...
Для создания правила перейдите на вкладку **Пользователи -> VPN-подключения -> Выдача IP-адресов** и нажмите **Добавить**.
...
На вкладке можно создать правила для передачи маршрутов.
...
Для настройки правил доступа, перейдите на вкладку **Пользователи -> VPN-подключения -> Передача маршрутов** и нажмите **Добавить**.
