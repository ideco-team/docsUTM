...
Используйте [личный кабинет пользователя](/settings/services/user-personal-account.md) для раздачи инструкций по созданию пользовательских VPN-подключений.
...
Если используется сертификат Let's Encrypt, обновление будет происходить автоматически. Подробнее о сертификатах можно узнать в [статье](/settings/services/certificates/README.md).
{% endhint %}
