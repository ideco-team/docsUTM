...
Для авторизации пользователю потребуется отсканировать QR код или использовать токен. Подробнее в [Аутентификации пользователя](two-factor-authentication.md#autentifikaciya-polzovatelya).
