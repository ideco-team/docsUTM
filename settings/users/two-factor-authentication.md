...
Для авторизации пользователю потребуется отсканировать QR код или использовать токен. Подробнее в Аутентификации пользователя.
...
4\. Подключитесь по VPN и откройте браузер и введите код из приложений в соответствующее поле:

![](../../.gitbook/assets/two-fac7.png)

Для последующих авторизаций выполняйте действия из пункта четыре.
