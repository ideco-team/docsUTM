...
4\. Подключитесь по VPN, откройте браузер и введите код из приложения в соответствующее поле:
...
5\. Нажмите **Отправить код подтверждения**. На указанный в карточке пользователя UTM номер телефона поступит звонок. **Последние 4 цифры входящего номера являются кодом**:
