...
![](../../.gitbook/assets/user_ip_authrization_rule.png)
...
При этом способе авторизации Ideco UTM будет учитывать в качестве лицензируемых пользователей только точки доступа Wi-Fi. Статистика по трафику в отчетах также будет считаться только по этим пользователям.
