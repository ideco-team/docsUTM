...
При этом способе авторизации Ideco UTM будет учитывать только точки доступа Wi-Fi в качестве лицензируемых пользователей и статистика по трафику в отчетах будет только по этому пользователю.
