...
Если при проверке устройства пользователя логическое выражение HIP-профиля возвращает положительный результат, профиль закрепляется за сессией авторизации и отображается в таблице [Сессии пользователей](/settings/monitor/authorized-users.md). Если ни один HIP-профиль не совпал с сессией авторизации, то на сессию назначается специальный HIP-профиль **Устройство без профиля**. На одну сессию авторизации может быть назначено несколько профилей при совпадении.
