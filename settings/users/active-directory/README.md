---
description: >-
  Как настроить интеграцию с Microsoft Active Directory и Samba DC в Ideco NGFW.
---
...
В Ideco NGFW есть возможность односторонней синхронизации с контроллером домена на базе Microsoft Active Directory (AD) и Samba DC:

* При интеграции импортируются учетные записи и номера телефонов пользователей, исключая пароли; 
* При аутентификации пользователей проверка осуществляется средствами Active Directory или Samba DC.
...
<summary>Особенности интеграции с несколькими контроллерами домена</summary>
...
* **Название** - название правила, например, Ограничение скорости AD;
* **Применяются для** - выбор отдельного пользователя и/или группы;
