...
Перед настройкой убедитесь, что Ideco NGFW уже [введён в домен](settings\users\active-directory\entering-the-server-into-the-domain.md).
...
* **Авторизации через журнал безопасности Active Directory** - включите настройку. Рекомендуем использовать совместно с SSO-аутентефикацией;
