...
2\. В появившейся форме нажмите **Загрузить сертификат** и выберите сохраненный файл сертификата. О создании сертификата для Device VPN смотрите [статью](/settings/users/ideco-client/device-vpn-cert.md). Нажмите **Добавить**:
