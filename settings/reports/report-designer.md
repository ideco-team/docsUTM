...
После нажатия на кнопку **Создать** UTM сохранит все пользовательские настройки времени отправки во всех фильтрах (раз в день, раз в неделю и раз в месяц), но отправляться шаблон будет только в период, выбранный пользователем. \
Например:  
...
3\. Перейдите к редактированию отчета и выбираем **Раз в месяц**, откроются настройки, созданные в пункте 1.
