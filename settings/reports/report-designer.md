---
description: Как создать шаблоны отчетов и настроить их рассылку на электронную почту.
---
...
На этой вкладке создаются шаблоны со статистикой, которую можно посмотреть в браузере, отредактировать, отправить на электронную почту или сохранить в формате PDF или CSV.

Для создания шаблона нажмите **Добавить** в левом верхнем углу. Откроется меню настройки шаблона. Задайте временной промежуток, название отчета и нажмите **Добавить виджет**:
...
Если в таблице большое количество отчетов, воспользуйтесь кнопкой **Фильтры**.
