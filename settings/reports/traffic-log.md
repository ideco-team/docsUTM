...
При наличии большого количества строк в таблице воспользуйтесь кнопкой **Фильтры**. При фильтрации по **Таблице правил (Файрвол)** можно вывести срабатывния системных правил (Forward System и Input System). Это правила **Файрвола**, которыми нелья управлять из веб-интерфейса Ideco NGFW, они всегда включены. Правила Forward System и Input System имеют приоритет над пользовательскими правилами **Файрвола**.
