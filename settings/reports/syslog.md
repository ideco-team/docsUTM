...
Логирование включается в разделе **Правила трафика -> Файрвол -> Логирование**. Включите опцию **Логировать срабатывания правил** и выберите **Действия для логирования**. 
