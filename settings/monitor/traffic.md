---
description: >-
  Отображает данные о трафике, проходящем через Ideco NGFW, в режиме реального времени.
---

# Монитор трафика

В разделе **Мониторинг -> Монитор трафика** можно просматривать данные о трафике (вх./исх. скорость, количество сессий), проходящем через Ideco NGFW в режиме реального времени.

{% hint style="info" %}
Для работы **Монитора трафика** необходимо необходимо включить [Контроль приложений](/settings/security-profiles/application-control/README.md).
{% endhint %}

Раздел **Монитор трафика** состоит из вкладок:

{% tabs %}

{% tab title="По источнику трафика" %}
