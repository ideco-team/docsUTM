...
Когда резервная нода в [Кластере](/settings/server-management/cluster/cluster.md) становится активной, статистика с предыдущей активной ноды не передается новой, но продолжает храниться до 90 дней.
{% endhint %}
