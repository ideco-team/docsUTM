---
title: Настройка Локального Ethernet
...
2. Нажмите на иконку ![ok\_with\_icon.png](../../.gitbook/assets/ok-with-icon.png) в правом верхнем углу окна и выберите пункт **Локальный Ethernet**. 
...
![](../../.gitbook/assets/local-ethernet-dhcp.png)