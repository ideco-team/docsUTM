...
2. Нажмите на иконку ![](<../../.gitbook/assets/ok-with-icon (3).png>) в правом верхнем углу окна и выберите пункт **Внешний Ethernet**. ![](../../.gitbook/assets/create-int.jpg)
...
1. Перейдите в меню **Сервисы** -> **Сетевые интерфейсы**;
2. Нажмите на иконку ![](<../../.gitbook/assets/ok-with-icon (3).png>) в правом верхнем углу окна и выберите пункт **Внешний Ethernet**;
3. Выберите сетевую карту;
