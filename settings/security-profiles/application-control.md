...
В 18 версии Ideco NGFW созданные в разделе **Профили безопасности -> Контроль приложений** профили применяются при создании и редактировании правил в разделе **Правила трафика -> Файрвол**. 
...
Из-за этого рекомендуем начать обновление на 18 версию с Ideco Center. После обновления Ideco Center приступить к обновлению синхронизированного Ideco NGFW. 

После обновления Ideco Center на 18 версию, синхронизированные из Ideco Center правила в **Правила трафика -> Контроль приложений** будут доступны только для просмотра и не будут влиять на обработку трафика в подключенных NGFW. 
