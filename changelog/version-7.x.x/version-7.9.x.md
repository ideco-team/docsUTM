...
* В фаервол добавлена кнопка разрыва текущих сессий. Сессии больше не разрываются принудительно при создании или редактировании текущих правил.
...
* Увеличено количество отображаемых строк на странице в таблице правил фаервола.
...
При обновлении с версий 7.8.х необходимо вручную перенастроить правила фаервола. При миграции правил все правила, кроме DNAT будут отключены, а некоторые правила нужно будет создать заново вручную либо включить. Из-за изменения логики работы фаервола (слияние "пользовательского" и "системного" фаерволов - автоматическая миграция правил "один-в-один" невозможна).\
...
* Новый фаервол. Объединены функции "пользовательского" и "системного" фаервола.
* Добавлен редактор "Объектов": IP-адресов, диапазонов IP-адресов, сетей, доменов, портов, временных промежутков.
* Созданные объекты можно использовать в правилах фаервола, а в будущем и других модулей фильтрации трафика.
