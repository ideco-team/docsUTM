...
* Новые правила фаервола применяются автоматически, без необходимости разрыва текущих соединений.
* Правила фаервола применяются и к веб-трафику (80 и 443 портам).
