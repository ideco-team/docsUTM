...
## Ideco NGFW 18.9 сборка 31 (17.04.2025)
...
## Ideco NGFW 18.8 сборка 18 (21.03.2025)
...
<table><thead><tr><th width="156">Номер задачи</th><th>Описание изменения</th></tr></thead><tbody><tr><td>ICS-45395</td><td>Добавлена возможность фильтрации трафика между локальными интерфейсами с помощью профилей контроля приложений и IPS</td></tr><tr><td>ICS-46578</td><td>Исправлено логирование пароля при неудачном входе в Active Directory/Samba домен</td></tr><tr><td>ICS-46086</td><td>Исправлено создание некоторых отчетов в конструкторе отчетов для администратора с ролью Создание отчетов</td></tr><tr><td>ICS-46009</td><td>Исправлена ошибка в профиле WAF после переключения нод кластера</td></tr><tr><td>ICS-45520</td><td>Из списка DNSBL-серверов исключен прекративший работу ix.dnsbl.manitu.net</td></tr><tr><td>ICS-45393</td><td>Исправлен вывод "нулевых" значений в отчетах по трафику</td></tr><tr><td>ICS-45371</td><td>Улучшена фильтрация приложений в модуле Контроль приложений</td></tr><tr><td>ICS-45043</td><td>Исправлен скрытый запуск терминала для администратора с правами только для чтения</td></tr><tr><td>ICS-43723</td><td>Исправлено логирование событий WAF в некоторых условиях</td></tr><tr><td>ICS-41743</td><td>Исправлена работа сети в облачной среде с оборудованием Huawei</td></tr><tr><td>ICS-40783</td><td>Исправлены неверные права доступа к каталогам для chronyd</td></tr></tbody></table>
