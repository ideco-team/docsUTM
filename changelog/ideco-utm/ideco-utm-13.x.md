...
* Добавлена [Двухфакторная аутентификация](../../settings/users/authorization/vpn-connection/two-factor-authentication.md) пользователей по VPN;
...
* Исправлено отображение графиков загруженности сервера при подключении из [Центральной Консоли](../../settings/server-management/central-console/README.md);
