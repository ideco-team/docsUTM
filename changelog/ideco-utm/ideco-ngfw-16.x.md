...
## IDECO NGFW 16.3 сборка ХХ (ХХ.ХХ.ХХ)
...
| ICS-34282 | Устранена уявзимость типа «межсайтовый скриптинг» (XSS) на веб-странице двухфакторной аутентификации |
...
| ICS-33935 | исправлена исходящее соединение по IPSec по нескольким IP-адресам |
