...
```
После успешной авторизации, сервер Ideco NGFW передаёт в заголовках куки. Пример значений:
...
```
После успешной разавторизации, сервер Ideco NGFW передаёт в заголовках куки. Пример значений:
