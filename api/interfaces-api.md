...
* `monitor_interfaces` - список id алиасов интерфейсов, трафик с которых надо зеркалировать. Допустимые типы алиасов: 'isp', 'lan', 'ipsec', 'ipsec_gre', 'tunnel';
...
```json5
{
  "id": "string"  // уникальный идентификатор созданного SPAN интерфейса
}
```
