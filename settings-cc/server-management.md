...
В Ideco Center вы можете создать локальных администраторов или интегрировать администраторов из сервиса RADIUS.
Добавление администраторов аналогично статье [Администраторы](/settings/server-management/admins.md).

Локальным администраторам могут быть назначены разные роли:
...
* **Администратор информационной безопасности** - адмистратор с этой ролью имеет доступ к собятиям безопасности;
* **Администратор файрвола** - администратор с этой ролью может создавать учетные записи, настраивать правила фильтрации и управлять режимами работы файрвола;
* **Администратор настройки доступов** - администратор с этой ролью  сетевого взаимодействии пользователей файрвола, субъектов доступа, информационных систем.
...
Для получения доступа по SSH из локальной сети включите опцию. Доступ осуществляется по 22 TCP-порту. Попытки подбора паролей также будут автоматически блокироваться.
...
Обновить систему Ideco Center можно в разделе **Управление сервером -> Обновления**.
...
Чтобы восстановить предыдущую ваерсию через локальное меню Ideco Center, выполните действия:

1\. Выберите пункт **15** и нажмите **Enter**.

![](../.gitbook/assets/cc-local-menu1.png)

 Система будет перезагружена, при этом текущие настройки будут потеряны. После восстановления отложите автоматическое обновление.
...
![](../.gitbook/assets/cc-local-menu3.png)
