...
В версии 18.1 раздел **Правила трафика -> Контроль приложений** полностью исчезнет. Подробнее о **профилях Контроля приложений** в [статье](/settings-cc/security-profiles.md).
{% endhint %}
