...
Возможно массовое создание пользователей для их авторизации по IP. Подробнее об этом можно прочитать в [статье](user-authorization/avtorizaciya-po-ip-adresu.md), посвященной этому типу авторизации.
