...
Сделать это можно, войдя на UTM по ssh от root, включив на UTM [режим удаленного помощника](../../obsluzhivanie/rezhim_udalennogo_pomoshnika.md) и выполнив команды, приведенные ниже.
