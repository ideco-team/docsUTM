...
2. Включите флажок **Авторизация PPTP**.
3. Нажмите на кнопку **Сохранить**.

![](../../../.gitbook/assets/pptp_on.png)
...
Выполните рекомендации статьи [Особенности маршрутизации и организации доступа](osobennosti-marshrutizacii-i-organizacii-dostupa.md).
