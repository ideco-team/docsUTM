...
3. Пункт **Использовать мое подключение к Интернету \(VPN\)**.  
...
2. Перейти в HKEY\_LOCAL\_MACHINE\SYSTEM\CurrentControlSet\Services\PolicyAgent и создать DWORD-параметр с именем AssumeUDPEncapsulationContextOnSendRule и значением 2. 
