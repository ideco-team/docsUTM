...
1. В Ideco UTM откройте вкладку **Сервисы -&gt; IPSec -&gt; Устройства**, нажмите на значок ![ok\_with\_icon.png](../../../../.gitbook/assets/ok_with_icon%20%283%29%20%283%29%20%281%29.png) и заполните следующие поля:
