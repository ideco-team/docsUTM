...
Можно импортировать разные группы пользователей AD в различные группы Ideco UTM, для удобства назначения на них правил [файрвола](../../pravila_dostupa/fairvol.md), [контентной фильтрации](../../pravila_dostupa/kontent-filtr/), [контроля приложений](../../pravila_dostupa/kontrol_prilozhenii/), [ограничения полосы пропускания](../../pravila_dostupa/ogranichenie_skorosti.md) и других модулей.
